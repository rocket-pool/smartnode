...
func RecoverMinipoolKeys(c *cli.Context, rp *rocketpool.RocketPool, address common.Address, w *wallet.LocalWallet, testOnly bool) ([]types.ValidatorPubkey, error) {
...
func CheckForAndRecoverCustomMinipoolKeys(cfg *config.RocketPoolConfig, pubkeyMap map[types.ValidatorPubkey]bool, w *wallet.LocalWallet, testOnly bool) (map[types.ValidatorPubkey]bool, error) {
