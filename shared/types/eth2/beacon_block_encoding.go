...
// Hash: 794a242cdff3605bff8fd403cf67e4c3d0e9d8fb76e96aac93d561143014edc7
// Version: 0.1.3
package eth2
...
func (b *BeaconBlockBodyDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.BlobKzgCommitments); size > 6 {
		err = ssz.ErrListTooBigFn("BeaconBlockBodyDeneb.BlobKzgCommitments", size, 6)
		return
	}
