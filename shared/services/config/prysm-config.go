...
// v2.1.3
const (
	prysmBnTagAmd64Test     string = "prysmaticlabs/prysm-beacon-chain:HEAD-4e225f-debug"
	prysmVcTagAmd64Test     string = "prysmaticlabs/prysm-validator:HEAD-4e225f-debug"
