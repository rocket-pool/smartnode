...
const (
	prysmBnTest             string = "rocketpool/prysm:v5.2.0"
	prysmBnProd             string = "rocketpool/prysm:v5.2.0"
	prysmVcTest             string = "rocketpool/prysm:v5.2.0"
	prysmVcProd             string = "rocketpool/prysm:v5.2.0"
