...
func NewExternalLighthouseConfig(cfg *RocketPoolConfig) *ExternalLighthouseConfig {
	return &ExternalLighthouseConfig{
		...
		ContainerTag: config.Parameter{
			ID:                 "containerTag",
			Name:               "Container Tag",
			Description:        "The tag name of the Lighthouse container you want to use from Docker Hub. Official pins are in images.env. TUI container-tag changes are written there and replaced on the next Smart Node install. This will be used for the Validator Client that Rocket Pool manages with your minipool keys.",
			Type:               config.ParameterType_String,
...
func NewExternalLodestarConfig(cfg *RocketPoolConfig) *ExternalLodestarConfig {
	return &ExternalLodestarConfig{
		...
		ContainerTag: config.Parameter{
			ID:                 "containerTag",
			Name:               "Container Tag",
			Description:        "The tag name of the Lodestar container you want to use from Docker Hub. Official pins are in images.env. TUI container-tag changes are written there and replaced on the next Smart Node install. This will be used for the Validator Client that Rocket Pool manages with your minipool keys.",
			Type:               config.ParameterType_String,
...
func NewExternalNimbusConfig(cfg *RocketPoolConfig) *ExternalNimbusConfig {
	...
	return &ExternalNimbusConfig{
		...
		ContainerTag: config.Parameter{
			ID:                 "containerTag",
			Name:               "Container Tag",
			Description:        "The tag name of the Nimbus validator container you want to use from Docker Hub. Official pins are in images.env. TUI container-tag changes are written there and replaced on the next Smart Node install. This will be used for the Validator Client that Rocket Pool manages with your minipool keys.",
			Type:               config.ParameterType_String,
...
func NewExternalPrysmConfig(cfg *RocketPoolConfig) *ExternalPrysmConfig {
	return &ExternalPrysmConfig{
		...
		ContainerTag: config.Parameter{
			ID:                 "containerTag",
			Name:               "Container Tag",
			Description:        "The tag name of the Prysm validator container you want to use from Docker Hub. Official pins are in images.env. TUI container-tag changes are written there and replaced on the next Smart Node install. This will be used for the Validator Client that Rocket Pool manages with your minipool keys.",
			Type:               config.ParameterType_String,
...
func NewExternalTekuConfig(cfg *RocketPoolConfig) *ExternalTekuConfig {
	return &ExternalTekuConfig{
		...
		ContainerTag: config.Parameter{
			ID:                 "containerTag",
			Name:               "Container Tag",
			Description:        "The tag name of the Teku container you want to use from Docker Hub. Official pins are in images.env. TUI container-tag changes are written there and replaced on the next Smart Node install. This will be used for the Validator Client that Rocket Pool manages with your minipool keys.",
			Type:               config.ParameterType_String,
