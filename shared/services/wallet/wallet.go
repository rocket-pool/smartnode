...
// Create new wallet
func NewWallet(walletPath, chainID string, passwordManager *passwords.PasswordManager) (*Wallet, error) {
    biChainID := new(big.Int)
    if _, ok := biChainID.SetString(chainID, 10); !ok {
