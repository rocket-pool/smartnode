...
func (c *Client) CanPromoteMinipool(address common.Address) (api.CanPromoteMinipoolResponse, error) {
	responseBytes, err := c.callHTTPAPI("GET", "/api/minipool/can-promote", url.Values{"address": {address.Hex()}})
	if err != nil {
...
func (c *Client) PromoteMinipool(address common.Address) (api.PromoteMinipoolResponse, error) {
	responseBytes, err := c.callHTTPAPI("POST", "/api/minipool/promote", url.Values{"address": {address.Hex()}})
	if err != nil {
...
func (c *Client) CanBeginReduceBondAmount(address common.Address, newBondAmountWei *big.Int) (api.CanBeginReduceBondAmountResponse, error) {
	responseBytes, err := c.callHTTPAPI("GET", "/api/minipool/can-begin-reduce-bond-amount", url.Values{
		"address":          {address.Hex()},
		"newBondAmountWei": {newBondAmountWei.String()},
	})
	if err != nil {
...
func (c *Client) BeginReduceBondAmount(address common.Address, newBondAmountWei *big.Int) (api.BeginReduceBondAmountResponse, error) {
	responseBytes, err := c.callHTTPAPI("POST", "/api/minipool/begin-reduce-bond-amount", url.Values{
		"address":          {address.Hex()},
		"newBondAmountWei": {newBondAmountWei.String()},
	})
	if err != nil {
...
func (c *Client) CanReduceBondAmount(address common.Address) (api.CanReduceBondAmountResponse, error) {
	responseBytes, err := c.callHTTPAPI("GET", "/api/minipool/can-reduce-bond-amount", url.Values{"address": {address.Hex()}})
	if err != nil {
...
func (c *Client) ReduceBondAmount(address common.Address) (api.ReduceBondAmountResponse, error) {
	responseBytes, err := c.callHTTPAPI("POST", "/api/minipool/reduce-bond-amount", url.Values{"address": {address.Hex()}})
	if err != nil {
...
func (c *Client) GetBondReductionEnabled() (api.GetBondReductionEnabledResponse, error) {
	responseBytes, err := c.callHTTPAPI("GET", "/api/minipool/get-bond-reduction-enabled", nil)
	if err != nil {
