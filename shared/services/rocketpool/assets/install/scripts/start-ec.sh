...
if [ "$CLIENT" = "geth" ]; then
    ...
    # Run Geth normally
        ...
        if [ "$NETWORK" = "devnet" ]; then
            CMD="$CMD --bootnodes enode://cd3bbaac20e4ae077dc38b035434c148acafe6e18dc3f3cf8c3fb5ddf4e79aaf96d08110a9ff210077116a704df37da1a0ee6a5bdcd130d852b0a5f579a6f8d0@57.128.20.31:32000"
        fi
