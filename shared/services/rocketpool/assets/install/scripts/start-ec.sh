...
if [ "$CLIENT" = "geth" ]; then
    ...
    # Run Geth normally
        ...
        if [ "$NETWORK" = "devnet" ]; then
            CMD="$CMD --bootnodes enode://f31757b2a14d41c62abf48d529d9cb1fcbda2fd24a72b60e929a8e3977d4cffeb4f3c58a7b07f24a2bc0844c4f59c6a698cb6a362b1ed1c0658aecc195f6abb8@57.128.20.31:32000"
        fi
