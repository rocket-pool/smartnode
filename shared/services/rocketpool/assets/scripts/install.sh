...
{ cp	\
	...
	"$PACKAGE_FILES_PATH/grafana-dashboards.yml" \
	"$PACKAGE_FILES_PATH/networks-default.yml" "$RP_PATH" || fail "Could not copy base files to the Rocket Pool user data directory."; } >&2
