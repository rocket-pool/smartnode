...
func (r *treeGeneratorImpl_v9_rolling) generateTree(rp *rocketpool.RocketPool, cfg *config.RocketPoolConfig, bc beacon.Client) (IRewardsFile, error) {
...
func (r *treeGeneratorImpl_v9_rolling) generateMerkleTree() error {
...
func (r *treeGeneratorImpl_v9_rolling) updateNetworksAndTotals() {
