		...
		Subcommands: []cli.Command{
...

			{
				...
				Flags: []cli.Flag{
					...
					cli.StringFlag{
						Name:  "address, a",
						Usage: "If you are recovering a wallet that was not generated by theSmart Node and don't know the derivation path or index of it, enter the address here. TheSmart Node will search through its library of paths and indices to try to find it.",
					},
				},
				Action: func(c *cli.Context) error {
