...
func NewNativeFallbackConfigPage(home *settingsNativeHome) *NativeFallbackConfigPage {
	...
	configPage.page = newPage(
		...
		"Fallback Clients",
		"Select this to manage a separate pair of externally-managed Execution and Consensus clients that theSmart Node will use if your main Execution or Consensus clients ever go offline.",
