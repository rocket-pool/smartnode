...
sszgen --path ./shared/types/eth2/fork/deneb --include ./shared/types/eth2/generic
sszgen --path ./shared/types/eth2/fork/electra --include ./shared/types/eth2/generic
sszgen --path ./shared/types/eth2/generic --exclude-objs Uint256
