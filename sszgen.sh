...
$SSZGEN_CMD --path ./shared/types/eth2/fork/fulu --include ./shared/types/eth2/generic
$SSZGEN_CMD --path ./shared/types/eth2/fork/gloas --include ./shared/types/eth2/generic
