...
require (
	...
	github.com/rocket-pool/node-manager-core v0.3.1-0.20240506214639-c2883a64174b
	github.com/rocket-pool/rocketpool-go/v2 v2.0.0-b2.0.20240627175310-e0f4975a1955
