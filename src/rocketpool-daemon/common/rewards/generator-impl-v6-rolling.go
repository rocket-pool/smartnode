...
func (r *treeGeneratorImpl_v6_rolling) generateTree(context context.Context, rp *rocketpool.RocketPool, cfg *config.SmartNodeConfig, bc beacon.IBeaconClient) (sharedtypes.IRewardsFile, error) {
...
func (r *treeGeneratorImpl_v6_rolling) approximateStakerShareOfSmoothingPool(context context.Context, rp *rocketpool.RocketPool, cfg *config.SmartNodeConfig, bc beacon.IBeaconClient) (*big.Int, error) {
...
func (r *treeGeneratorImpl_v6_rolling) calculateEthRewards(context context.Context, checkBeaconPerformance bool) error {
	...
	startElBlockHeader, err := r.getStartBlocksForInterval(context)
	if err != nil {
		return err
	}
...
func (r *treeGeneratorImpl_v6_rolling) getStartBlocksForInterval(context context.Context) (*types.Header, error) {
