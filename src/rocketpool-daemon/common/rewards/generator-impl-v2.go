...
func (r *treeGeneratorImpl_v2) generateTree(context context.Context, rp *rocketpool.RocketPool, cfg *config.SmartNodeConfig, bc beacon.IBeaconClient) (sharedtypes.IRewardsFile, error) {
...
func (r *treeGeneratorImpl_v2) approximateStakerShareOfSmoothingPool(context context.Context, rp *rocketpool.RocketPool, cfg *config.SmartNodeConfig, bc beacon.IBeaconClient) (*big.Int, error) {
...
func (r *treeGeneratorImpl_v2) calculateEthRewards(context context.Context, checkBeaconPerformance bool) error {
...
func (r *treeGeneratorImpl_v2) processAttestationsForInterval(context context.Context) error {
...
func (r *treeGeneratorImpl_v2) processEpoch(context context.Context, getDuties bool, epoch uint64) error {
...
func (r *treeGeneratorImpl_v2) createMinipoolIndexMap(context context.Context) error {
...
func (r *treeGeneratorImpl_v2) getStartBlocksForInterval(context context.Context, previousIntervalEvent rewards.RewardsEvent) (*types.Header, error) {
