...
require (
	...
	github.com/rocket-pool/node-manager-core v0.1.1-0.20240312053517-ff35243d9707
	github.com/rocket-pool/rocketpool-go v1.10.1-0.20240308080512-77189d8e0758
