...
func (m *minipoolDelegateManager) CheckState(node *node.Node, response *api.GetMinipoolDelegateDetailsForNodeResponse) bool {
	return true
}
...
func (m *minipoolDelegateManager) PrepareResponse(rp *rocketpool.RocketPool, bc beacon.Client, addresses []common.Address, mps []minipool.Minipool, response *api.GetMinipoolDelegateDetailsForNodeResponse) error {
