...
func (m *minipoolCloseManager) CheckState(node *node.Node, response *api.MinipoolCloseDetailsData) bool {
...
func (m *minipoolCloseManager) PrepareResponse(rp *rocketpool.RocketPool, bc beacon.Client, addresses []common.Address, mps []minipool.Minipool, response *api.MinipoolCloseDetailsData) error {
