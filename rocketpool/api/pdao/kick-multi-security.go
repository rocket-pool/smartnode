...
func (f *protocolDaoProposeKickMultiFromSecurityCouncilContextFactory) Create(vars map[string]string) (*protocolDaoProposeKickMultiFromSecurityCouncilContext, error) {
