...
func canProposeRequestLeave(c *cli.Context) (*api.SecurityCanProposeLeaveResponse, error) {
...
func proposeRequestLeave(c *cli.Context) (*api.SecurityProposeLeaveResponse, error) {
