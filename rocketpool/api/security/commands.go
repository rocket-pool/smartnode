		...
		Subcommands: []cli.Command{
			...
			/*
...

				{
					...
					UsageText: "rocketpool api security can-propose-invite member-address member-id member-url",
					Action: func(c *cli.Context) error {
				...
				},
				{
					...
					UsageText: "rocketpool api security propose-invite member-address member-id member-url",
					Action: func(c *cli.Context) error {
				...
				},
				{
					...
					Action: func(c *cli.Context) error {
						...
						memberAddresses, err := cliutils.ValidateAddress("member addresses", c.Args().Get(0))
						if err != nil {
							return err
						}
						// Run
				...
				},
				{
					...
					Aliases:   []string{"j1"},
					Usage:     "Approves the RPL bond transfer prior to join the security council",
					UsageText: "rocketpool api security join-approve-rpl",
					Action: func(c *cli.Context) error {
				...
				},
				{
					...
					UsageText: "rocketpool api security join tx-hash",
					Action: func(c *cli.Context) error {
