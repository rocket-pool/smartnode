...
var minipoolV4Abi *abi.ABI

// Create new minipool contract
func newMinipool_v4(rp *rocketpool.RocketPool, address common.Address, opts *bind.CallOpts) (Minipool, error) {

	var contract *rocketpool.Contract
	var err error
	if minipoolV4Abi == nil {
		// Get contract
		contract, err = createMinipoolContractFromEncodedAbi(rp, address, minipoolV4EncodedAbi)
	} else {
		contract, err = createMinipoolContractFromAbi(rp, address, minipoolV4Abi)
	}
	if err != nil {
		return nil, err
	} else if minipoolV4Abi == nil {
		minipoolV4Abi = contract.ABI
	}
...
// Get the contract
func (mp *minipool_v4) GetContract() *rocketpool.Contract {
	return mp.Contract
}

// Get the contract address
func (mp *minipool_v4) GetAddress() common.Address {
	return mp.Address
}

// Get the contract version
func (mp *minipool_v4) GetVersion() uint8 {
	return mp.Version
}

// Get status details
func (mp *minipool_v4) GetStatusDetails(opts *bind.CallOpts) (StatusDetails, error) {
...
func (mp *minipool_v4) GetStatus(opts *bind.CallOpts) (rptypes.MinipoolStatus, error) {
	status := new(uint8)
...
func (mp *minipool_v4) GetStatusBlock(opts *bind.CallOpts) (uint64, error) {
...
func (mp *minipool_v4) GetStatusTime(opts *bind.CallOpts) (time.Time, error) {
...
func (mp *minipool_v4) GetFinalised(opts *bind.CallOpts) (bool, error) {
	finalised := new(bool)
...
// Get deposit type
func (mp *minipool_v4) GetDepositType(opts *bind.CallOpts) (rptypes.MinipoolDeposit, error) {
...
// Get node details
func (mp *minipool_v4) GetNodeDetails(opts *bind.CallOpts) (NodeDetails, error) {
...
func (mp *minipool_v4) GetNodeAddress(opts *bind.CallOpts) (common.Address, error) {
...
func (mp *minipool_v4) GetNodeFee(opts *bind.CallOpts) (float64, error) {
	nodeFee := new(*big.Int)
...
func (mp *minipool_v4) GetNodeDepositBalance(opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) GetNodeRefundBalance(opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) GetNodeDepositAssigned(opts *bind.CallOpts) (bool, error) {
...
func (mp *minipool_v4) GetVacant(opts *bind.CallOpts) (bool, error) {
	isVacant := new(bool)
...
func (mp *minipool_v4) GetPreMigrationBalance(opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) GetUserDetails(opts *bind.CallOpts) (UserDetails, error) {
...
func (mp *minipool_v4) GetUserDepositBalance(opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) GetUserDepositAssigned(opts *bind.CallOpts) (bool, error) {
...
func (mp *minipool_v4) GetUserDepositAssignedTime(opts *bind.CallOpts) (time.Time, error) {
...
func (mp *minipool_v4) Refund(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) GetUserDistributed(opts *bind.CallOpts) (bool, error) {
...
func (mp *minipool_v4) DistributeBalance(rewardsOnly bool, opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) PrepareDistributeBalance(rewardsOnly bool, opts *bind.TransactOpts) (*types.Transaction, error) {
	if opts == nil {
...
func (mp *minipool_v4) Stake(validatorSignature rptypes.ValidatorSignature, depositDataRoot common.Hash, opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) Dissolve(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) Close(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) Finalise(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) DelegateUpgrade(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) SetUseLatestDelegate(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) GetUseLatestDelegate(opts *bind.CallOpts) (bool, error) {
	setting := new(bool)
...
func (mp *minipool_v4) GetDelegate(opts *bind.CallOpts) (common.Address, error) {
...
func (mp *minipool_v4) GetPreviousDelegate(opts *bind.CallOpts) (common.Address, error) {
	address := new(common.Address)
...
func (mp *minipool_v4) GetEffectiveDelegate(opts *bind.CallOpts) (common.Address, error) {
	address := new(common.Address)
...
func (mp *minipool_v4) ReduceBondAmount(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) CalculateNodeShare(balance *big.Int, opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) CalculateUserShare(balance *big.Int, opts *bind.CallOpts) (*big.Int, error) {
...
func (mp *minipool_v4) VoteScrub(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) Promote(opts *bind.TransactOpts) (common.Hash, error) {
...
func (mp *minipool_v4) GetPrestakeEvent(intervalSize *big.Int, opts *bind.CallOpts) (PrestakeData, error) {
