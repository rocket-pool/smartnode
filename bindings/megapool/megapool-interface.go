...
type Megapool interface {
	...
	EstimateDequeueGas(validatorId uint32, opts *bind.TransactOpts) (gaslimit.Limits, error)
	Dequeue(validatorId uint32, opts *bind.TransactOpts) (common.Hash, error)
	EstimateDistributeGas(opts *bind.TransactOpts) (gaslimit.Limits, error)
	Distribute(opts *bind.TransactOpts) (common.Hash, error)
	EstimateAssignFundsGas(validatorId uint32, opts *bind.TransactOpts) (gaslimit.Limits, error)
	AssignFunds(validatorId uint32, opts *bind.TransactOpts) (common.Hash, error)
	EstimateDissolveValidatorGas(validatorId uint32, opts *bind.TransactOpts) (gaslimit.Limits, error)
	DissolveValidator(validatorId uint32, opts *bind.TransactOpts) (common.Hash, error)
	EstimateClaimRefundGas(opts *bind.TransactOpts) (gaslimit.Limits, error)
